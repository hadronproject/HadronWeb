...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('frontend', ['Page'])

        # Adding model 'News'
        db.create_table('frontend_news', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('entry', self.gf('django.db.models.fields.TextField')()),
            ('created_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('frontend', ['News'])


    def backwards(self, orm):
        # Deleting model 'Page'
        db.delete_table('frontend_page')

        # Deleting model 'News'
        db.delete_table('frontend_news')
